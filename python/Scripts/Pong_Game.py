...
def draw(canvas):
	...
	canvas.draw_line([PAD_WIDTH, 0], [PAD_WIDTH, PAD_HEIGHT], 1, "Red")
	...
	if paddle2_pos <= -HEIGHT / 2 +  PAD_HEIGHT / 2:
		...
		paddle2_pos = PAD_HEIGHT / 2 - PAD_HEIGHT / 2
		
	canvas.draw_line([PAD_WIDTH / 2, paddle1_pos + HEIGHT / 2 - PAD_HEIGHT / 2] , [PAD_WIDTH / 2, paddle1_pos + PAD_HEIGHT / 2, + paddle1_pos + HEIGHT / 2], 10, "White" )
